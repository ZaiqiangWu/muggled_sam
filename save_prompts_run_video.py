...
video_path = args.input_video#ask_for_path_if_missing(arg_image_path, "video", history_vidpath) if not use_webcam else 0
...
KEY_ZOOM_IN = ord("=")
KEY_ZOOM_OUT = ord("-")
KEY_BATCH = ord("g") # key for headless processing
